...
def intensity_based_registration_rigid_nCC(I, Im):
    ...
    ax2.set_title('correlation, rigid transformation')
    ax2.grid()
...
def intensity_based_registration_affine_nCC(I, Im):
...
def intensity_based_registration_affine_MI(I, Im):
    ...
    ax2.set_title('mutual information, affine transformation')
    ax2.grid()
